...
import 'package:habitual/widgets/add_action_button.dart';
import 'package:habitual/widgets/views/add_habit_view.dart';
import 'package:habitual/widgets/nav_components/disappearing_navigation_rail.dart';
import 'package:habitual/widgets/nav_components/disappearring_nav_bar.dart';
import 'package:habitual/widgets/views/habit_history_view.dart';
import 'package:habitual/widgets/views/habit_list_view.dart';
import 'package:habitual/widgets/views/settings_view.dart';
import 'package:habitual/widgets/views/habit_day_view.dart';
import 'package:habitual/widgets/habit_timer_view.dart';
                    ...
                    if (_state == AppState.timerForm) {
                      return Expanded(
                        child: AnimatedBuilder(
                          ...
                          child: HabitTimerView(habit: _selectedHabit!, date: _selectedDate, onClose: () {
                            _formAnimationController.reverse().whenComplete(() {
                                  setState(() {
                                    _state = AppState.main;
                                    _selectedHabit = null;
